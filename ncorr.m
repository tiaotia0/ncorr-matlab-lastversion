...
%-------------------------------------------------------------------------%
    ...
    methods(Access = private)
        ...
        % handle pointing to ncorr
            ...
            if (isempty(name))
                % No handle exists
                set(obj.handles_gui.figure,'Name','Sjtu'); 
            else
                % Handle exists
        ...
        % This function updates menu items depending on what is loaded
            ...
            if (~isempty(obj.reference))            
                ...
                set(obj.handles_gui.button_setcur,'Enable','on'); 
            else
                set(obj.handles_gui.topmenu_setroi_ref,'Enable','off'); 
                set(obj.handles_gui.button_setcur,'Enable','off');
            end
            
            % Current image is loaded:
            if (~isempty(obj.current))            
                set(obj.handles_gui.topmenu_setroi_cur,'Enable','on'); 
                set(obj.handles_gui.button_setroi,'Enable','on'); 
            else
                set(obj.handles_gui.topmenu_setroi_cur,'Enable','off');
                set(obj.handles_gui.button_setroi,'Enable','off');
            end
            ...
            if (~isempty(obj.reference) && ~isempty(obj.current) && ~isempty(obj.data_dic.dispinfo) && ...
                ...
                set(obj.handles_gui.button_setpara,'Enable','on');
            else
                set(obj.handles_gui.topmenu_setdicparameters,'Enable','off');
                set(obj.handles_gui.button_setpara,'Enable','off');
            end
            ...
            if (~isempty(obj.reference) && ~isempty(obj.current) && ~isempty(obj.data_dic.dispinfo) && ...
                ...
                set(obj.handles_gui.button_perform,'Enable','on');
            else
                set(obj.handles_gui.topmenu_perfdic,'Enable','off');
                set(obj.handles_gui.button_perform,'Enable','off');
            end   
        ...
        function update_axes(obj,action)    
            ...
            if (strcmp(action,'set'))
                ...
                if (isempty(obj.reference))
                    ...
                    ss = obj.reference.imginfo.get_img();
        ...
        function handles_gui = init_gui(obj)
            ...
            % Panels -----------------------------------------------------%
            handles_gui.group_button = uibuttongroup( ...
                'Parent', handles_gui.figure, ...
                'Tag', 'group_button', ...
                'Units', 'characters', ...
                'Position', [2 25 35 25], ...
            ...
            handles_gui.link1 = axes( ...
                'Parent', handles_gui.group_button, ...
                'Tag', 'link1', ...
                'Units', 'characters', ...
                'Position', [13 17.9 10.5 3],...
                'Visible', 'on', ...
                'handlevisibility','off', ...
                'Interruptible','off');
            imshow('link.png','Parent',handles_gui.link1);
            
            handles_gui.link2 = axes( ...
                'Parent', handles_gui.group_button, ...
                'Tag', 'link2', ...
                'Units', 'characters', ...
                'Position', [13 12.9 10.5 3],...
                'Visible', 'on', ...
                'handlevisibility','off', ...
                'Interruptible','off');
            imshow('link.png','Parent',handles_gui.link2);
            
            handles_gui.link3 = axes( ...
                'Parent', handles_gui.group_button, ...
                'Tag', 'link3', ...
                'Units', 'characters', ...
                'Position', [13 7.9 10.5 3],...
                'Visible', 'on', ...
                'handlevisibility','off', ...
                'Interruptible','off');
            imshow('link.png','Parent',handles_gui.link3);
       
            handles_gui.link4 = axes( ...
                'Parent', handles_gui.group_button, ...
                'Tag', 'link4', ...
                'Units', 'characters', ...
                'Position', [13 2.9 10.5 3],...
                'Visible', 'on', ...
                'handlevisibility','off', ...
                'Interruptible','off');
            imshow('link.png','Parent',handles_gui.link4);
            
            handles_gui.link1 = axes( ...
                'Parent', handles_gui.group_button, ...
                'Tag', 'link1', ...
                'Units', 'characters', ...
                'Position', [13 17.8 10.5 3],...
                'Visible', 'on', ...
                'handlevisibility','off', ...
                'Interruptible','off');
            imshow('link.png','Parent',handles_gui.link1);
            ...
            handles_gui.button_setref = uicontrol( ...
                'Parent', handles_gui.group_button, ...
                'Tag', 'button_setref', ...
                'Style', 'pushbutton', ...
                'Units', 'characters', ...
                'Position', [5.5 21 25 1.8], ...
                'String', 'Set Reference Image', ...
                'Callback', obj.util_wrapcallbackall(ncorr_util_wrapcallbacktrycatch(@(hObject,eventdata) callback_topmenu_loadref(obj,hObject,eventdata),handles_gui.figure)), ...
                'Enable', 'on', ...
                'Interruptible','off');
            
            handles_gui.button_setcur = uicontrol( ...
                'Parent', handles_gui.group_button, ...
                'Tag', 'button_setcur', ...
                'Style', 'pushbutton', ...
                'Units', 'characters', ...
                'Position', [5.5 16 25 1.8], ...
                'String', 'Set Current Images', ...
                'Callback', obj.util_wrapcallbackall(ncorr_util_wrapcallbacktrycatch(@(hObject,eventdata) callback_topmenu_loadcur(obj,hObject,eventdata,true),handles_gui.figure)), ...
                'Enable', 'off', ...
                'Interruptible','off');
            
           handles_gui.button_setroi = uicontrol( ...
                'Parent', handles_gui.group_button, ...
                'Tag', 'button_setroi', ...
                'Style', 'pushbutton', ...
                'Units', 'characters', ...
                'Position', [5.5 11 25 1.8], ...
                'String', 'Set Roi Region', ...
                'Callback', obj.util_wrapcallbackall(ncorr_util_wrapcallbacktrycatch(@(hObject,eventdata) callback_topmenu_set_roi_ref(obj,hObject,eventdata),handles_gui.figure)), ...
                'Enable', 'off', ...
                'Interruptible','off');
            
           handles_gui.button_setpara = uicontrol( ...
                'Parent', handles_gui.group_button, ...
                'Tag', 'button_setpara', ...
                'Style', 'pushbutton', ...
                'Units', 'characters', ...
                'Position', [5.5 6 25 1.8], ...
                'String', 'Set DIC parameters', ...
                'Callback', obj.util_wrapcallbackall(ncorr_util_wrapcallbacktrycatch(@(hObject,eventdata) callback_topmenu_setdicparameters(obj,hObject,eventdata),handles_gui.figure)), ...
                'Enable', 'off', ...
                'Interruptible','off');
            
           handles_gui.button_perform = uicontrol( ...
                'Parent', handles_gui.group_button, ...
                'Tag', 'button_perform', ...
                'Style', 'pushbutton', ...
                'Units', 'characters', ...
                'Position', [5.5 1 25 1.8], ...
                'String', 'Peform DIC Analysis', ...
                'Callback', obj.util_wrapcallbackall(ncorr_util_wrapcallbacktrycatch(@(hObject,eventdata) callback_topmenu_dic(obj,hObject,eventdata),handles_gui.figure)), ...
                'Enable', 'off', ...
                'Interruptible','off');
        end
